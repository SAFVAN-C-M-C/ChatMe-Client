      ...
      <div className="main w-[70%] md:w-[80%] flex items-center  h-full ">
        <div className="main-row ml-2 mt-2 mb-2 w-full flex justify-between">
          <div className="recruiter flex items-center">
            <span className="text-base font-medium text-gray-600">Recruiter Name</span>{" "}
            
          </div>
          <div className="action flex">
          <div className="message mr-4  w-auto h-auto bg-slate-300 pt-1 pb-1 pl-5 pr-5 rounded-md">
            <span>ignore</span>
          </div>
          <div className="message w-auto h-auto bg-green-500 text-white pt-1 pb-1 pl-5 pr-5 rounded-md">
            <span>Accept</span>
          </div>
          </div>
