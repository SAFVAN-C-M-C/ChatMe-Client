  ...
  return (
    <>
      <div
        ...
        className="card job_card bg-slate-100 overflow-hidden shadow-cyan-900  border-blue-900 borderv h w-[300px] shadow-lg"
      ...
      >
        ...
        >
          <h2 className="card-title font-bold break-all whitespace-pre-wrap">
            {job.jobTitle}
          </h2>
