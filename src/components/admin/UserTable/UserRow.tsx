...
const UserRow: FC<UserRowProps> = ({ row }) => {
  ...
  return (
    <>
      <StyledTableRow>
        ...
        <StyledTableCell align="center">{user?.accountType}</StyledTableCell>
        <StyledTableCell align="center">{row.numberOfReportActions}</StyledTableCell>
        <StyledTableCell align="center">{row.isBlocked ? (
                        <button
